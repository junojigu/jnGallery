...
export const INITIAL_HOME_SETTINGS: HomeSettings = {
  ...
  heroTitle: 'Capture the Essence of Your Memories',
  heroSubtitle: 'Curate, organize, and relive your most precious moments in a distraction-free, elegant gallery designed for those who appreciate the quiet luxury of fine photography.',
  heroCtaText: 'Explore Your Gallery',
  aboutTitle: 'Intentional Curation',
  aboutDescription: 'We believe your photos deserve a space that doesn\'t compete for attention. Our minimalist approach strips away the clutter, leaving a pristine canvas where your imagery takes center stage. Every interaction is designed to be quiet, intuitive, and seamlessly beautiful.',
  feature1Icon: 'photo_library',
  feature1Title: 'Distraction-free',
  feature2Icon: 'view_cozy',
  feature2Title: 'Elegant Grids',
